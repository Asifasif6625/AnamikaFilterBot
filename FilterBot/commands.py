...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Update', url='https://t.me/Malayalam_vibe'),
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('Tutorial', url='https://t.me/MLaVIB'),
                   InlineKeyboardButton('Repo', url='https://t.me/malayalamvibe') ],
