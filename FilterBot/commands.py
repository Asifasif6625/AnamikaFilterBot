...
async def startCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[
      ...
      InlineKeyboardButton('Update', url='t.me/Malayalam_vibe'),
      InlineKeyboardButton('Support', url='t.me/MLaVIB')
      ]]
...
async def aboutCMD(client: FilterBot, message: Message):
    ...
    keyboard = [[ InlineKeyboardButton('Tutorial', url='https://youtu.be'),
